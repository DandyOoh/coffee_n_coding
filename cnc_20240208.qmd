...
Someone [Giorgio Comai](https://github.com/giocomai) basically came to the same conclusion as me and developed their own package [Ganttrify](https://github.com/giocomai/ganttrify).

Reasonably customisable, based on ggplot, works with numbered periods or real dates, shiny app if you're interested:
